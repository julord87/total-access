      ...
      <div className="flex flex-col justify-end flex-grow p-6 lg:p-16">
        ...
        <p className="text-lg lg:text-xl font-color my-3 justify-normal">
          {language === "EN"
            ...
            : "Con más de 15 años en movilidad y asesoría jurídica, nos especializamos en normativa migratoria, relocacion, permisos de trabajo y logística aduanera. Nuestro equipo multidisciplinario ofrece soluciones personalizadas y de alta calidad para que los clientes naveguen con confianza y eficiencia."}
        </p>
        <Link
